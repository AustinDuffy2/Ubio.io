...
const PropertyDetailsFaq3 = (props) => {
  return (
    <>
          ...
          <div className="bg-white-A700 flex flex-1 flex-col items-center justify-center p-2.5 w-full">
            <div className="flex flex-col gap-8 items-start justify-start w-full">
              <div className="flex flex-col gap-6 items-start justify-start w-full">
                ...
                <Text
                  className="leading-[150.00%] max-w-[621px] md:max-w-full text-black-900 text-lg"
              ...
              <Button
                className="bg-transparent cursor-pointer font-roboto min-w-[104px] outline outline-[1px] teal_A400_blue_400_border text-base text-center"
                shape="round"
...
PropertyDetailsFaq3.defaultProps = {
  faqs: "FAQs",
  texttwo:
...
export default PropertyDetailsFaq3;
