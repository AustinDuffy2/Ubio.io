...
const DataTrendsCta8 = (props) => {
  return (
    <>
      <div className={props.className}>
        <div className="bg-white-A700 flex md:flex-col flex-row gap-2.5 items-start justify-start p-2.5 w-full">
          <div className="bg-gray-200 flex flex-1 flex-col items-start justify-center p-2.5 w-full">
            <Text
              className="leading-[120.00%] max-w-[525px] md:max-w-full text-5xl sm:text-[38px] md:text-[44px] text-black-900"
          ...
          <div className="bg-gray-200 flex flex-1 flex-col items-center justify-center p-2.5 w-full">
            <div className="flex flex-col gap-6 items-start justify-start w-full">
              ...
              <div className="flex flex-row gap-4 items-start justify-start pt-4 w-auto">
                ...
                <Button
                  className="bg-transparent cursor-pointer font-roboto min-w-[96px] outline outline-[1px] teal_A400_blue_400_border7 text-base text-center"
                  shape="round"
